...
//mercury
mods.tconstruct.Casting.addTableRecipe(<extraplanets:ingot_mercury>, <tconstruct:cast_custom>, <liquid:mercury>, 144);
...
mods.tconstruct.Melting.addRecipe(<liquid:mercury> * 144,<extraplanets:mercury:6>, 300);
mods.tconstruct.Melting.addRecipe(<liquid:mercury> * 144,<extraplanets:compressed_mercury>, 300);
mods.tconstruct.Melting.addRecipe(<liquid:mercury> * 1296,<extraplanets:mercury:7>, 300);
//forge
